...
namespace ConsoleApp1
{
    class day11task2
    {
       public static void Main()
        {
            FileStream fs = new FileStream ("D:\\softura training\\Employee.txt",FileMode.OpenOrCreate, FileAccess.ReadWrite);
            ...
            bw.Flush();
            fs.Close();
            FileStream fs1 = new FileStream(@"D:\softura training\Employee.txt", FileMode.Open, FileAccess.ReadWrite);
